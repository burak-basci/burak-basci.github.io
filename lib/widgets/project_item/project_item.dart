...
class ProjectItemData {
  ...
  /// Small preview variant of an asset, by convention `<name>-thumb.webp`
  /// (900px wide, generated by `tools/gen_thumbs.py`).
  ///
  /// The home cascade paints its tiles ~770px wide, but the full covers
  /// ship at 1600x900 — 16.4 MB of WebP across the 99 covers, and ~5.8 MB
  /// of decoded RGBA *each*. The thumbs are 2.9 MB in total (18%) and
  /// decode to a third of the pixels. Detail pages keep the full-size
  /// asset, where the cover is actually painted large.
  ...
  String? get coverColorThumbUrl =>
      coverColorUrl == null ? null : _thumb(coverColorUrl!);
                  ...
                  Positioned(
                    ...
                    child: Transform(
                      ...
                      child: Image.asset(
                        ...
                        fit: BoxFit.cover,
                        // Mobile tile — decode to the painted size. Matters
                        // most here: phones have the least memory headroom.
                        cacheWidth: (widthOfProjectImageCover *
                                MediaQuery.devicePixelRatioOf(context))
                            .round()
                            .clamp(1, 4096),
                      ),
